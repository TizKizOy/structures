...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->настройкаРабочегоМестаToolStripMenuItem->Click += gcnew System::EventHandler(this, &MenuForm::настройкаРабочегоМестаToolStripMenuItem_Click);
			// 
			...
			this->изменениеКурсаВалютToolStripMenuItem->Click += gcnew System::EventHandler(this, &MenuForm::изменениеКурсаВалютToolStripMenuItem_Click);
			// 
...
#pragma endregion	
	...
	private: System::Void настройкаРабочегоМестаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		SettingsForm^ f5 = gcnew SettingsForm();
		if (f5->Visible == true)
		{
			f5->Close();
	...
	private: System::Void изменениеКурсаВалютToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		SettingsForm^ f5 = gcnew SettingsForm();
		if (f5->Visible == true)
		{
			f5->Close();
